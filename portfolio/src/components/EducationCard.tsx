...
const EducationCard: React.FC = () => {
  return (
    ...
    <div className="grid grid-cols-[1fr_2fr] gap-4" style={{
        marginTop: "23rem"
    }}>
        {/*Column 1 */}
        <div className="text-left mb-4 pl-10 items-center">
        ...
        <div className="flex justify-center items-center pr-10">
            <p>I'm a computer science major at Georgia Tech. I don't label 
                ...
                science degree I'm pursuing helps me think as a computer scientist. Hence why 
